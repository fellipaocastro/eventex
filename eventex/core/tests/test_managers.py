...
class ContactManagerTest(TestCase):
    def setUp(self):
        ...
        s.contact_set.add(Contact(kind='E', value='contact@fellipecastro.com'))
        s.contact_set.add(Contact(kind='P', value='21-996186180'))
        s.contact_set.add(Contact(kind='F', value='21-12345678'))

    def test_emails(self):
        qs = Contact.emails.all()
        expected = ['<Contact: contact@fellipecastro.com>']
...
class PeriodManagerTest(TestCase):
    ...
    def test_afternoon(self):
        'Should return only talks before 11:59:59.'
        self.assertQuerysetEqual(
